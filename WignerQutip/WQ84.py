...
'''
#%%
P=np.load('data/P84.npy')
W=np.load('data/W84.npy')
#%%
...
history=model.fit(inputV, outputV, epochs=20, batch_size=256, verbose=1, validation_split=0.1, callbacks=callbacks_list)
#%%
'''
with open('models/WQ84_Nsmaller5/model.json', 'w') as json_file:
    json_file.write(model.to_json())
model.save_weights('models/WQ84_Nsmaller5/weights.h5')
with open('models/WQ84r_Nsmaller5/history.json', 'w') as json_file:
